...
def passkey(presses, keymap, layer):
    ...
    if len(presses) == 1:
        ...
        keys = [keys[keymap["layer"+str(layer)][str(presses[0])]]]
    elif len(presses) == 2:
        kbd.press(keys[keymap["layer"+str(layer)][str(presses[0])]],keys[keymap["layer"+str(layer)][str(presses[1])]])
        keys = [keys[keymap["layer"+str(layer)][str(presses[0])]],keys[keymap["layer"+str(layer)][str(presses[1])]]]
    elif len(presses) == 3:
        ...
        keys = [keys[keymap["layer"+str(layer)][str(presses[0])]],keys[keymap["layer"+str(layer)][str(presses[1])]],keys[keymap["layer"+str(layer)][str(presses[2])]]]
    elif len(presses) == 4:
        ...
        keys = [keys[keymap["layer"+str(layer)][str(presses[0])]],keys[keymap["layer"+str(layer)][str(presses[1])]],keys[keymap["layer"+str(layer)][str(presses[2])]],keys[keymap["layer"+str(layer)][str(presses[3])]]]
    elif len(presses) == 5:
        ...
        keys = [keys[keymap["layer"+str(layer)][str(presses[0])]],keys[keymap["layer"+str(layer)][str(presses[1])]],keys[keymap["layer"+str(layer)][str(presses[2])]],keys[keymap["layer"+str(layer)][str(presses[3])]],keys[keymap["layer"+str(layer)][str(presses[4])]]]
    return [keys, pkeys]
    pkeys = keys

def release(presses):
    if not presses[0] or not presses[1]:
        kbd.release_all()
    for i in presses[0]:
        if not i in presses[1]:
            kbd.release(i)
